...
public class C02_listIterator {
    public static void main(String[] args) {
        ...
        while(li1.hasNext()){// yanda eleman oldukca yana gec
            li1.next();
        }
        // bu loop bizi sona goturur
        while(li1.hasPrevious()){// yanda eleman var mi sorar
            System.out.print(li1.previous()+ " ");// varsa yukle yazar 40 14 45 23 56 13 2  doner
