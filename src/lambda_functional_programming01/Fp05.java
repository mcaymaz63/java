...
public class Fp05 {
    public static void main(String[] args) {
        ...
        System.out.println("ortalamaPuanlarınVerilenSayıdanBüyükMu :"+ortalamaPuanlarınVerilenSayıdanBüyükMu(coursesList,93));
        System.out.println("herhangiBirKursAdiKelimeyiIceriyorMu :"+herhangiBirKursAdiKelimeyiIceriyorMu(coursesList,"X"));
...
//1)Tüm ortalama puanların verilen sayıdan büyük olup olmadığını kontrol etmek için bir method oluşturun. olup olmadığını kontrol etmek için bir method oluşturun.
    public static boolean ortalamaPuanlarınVerilenSayıdanBüyükMu(List<Courses>list,double x){
