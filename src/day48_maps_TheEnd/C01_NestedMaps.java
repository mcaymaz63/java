...
public class C01_NestedMaps {
  ...
  /*
        ...
        System.out.println(ogrenciNestedMap.get(101).get("isim"));

        System.out.println(ogrenciNestedMap.get(102).get("soyisim"));

        System.out.println(ogrenciNestedMap.get(103).get("brans"));
