...
public class C04_MdaIstenenArrayiOlusturma {
    public static void main(String[] args) {
       ...
       ic array’lerindeki tum elemanlarin toplamini  birer birer bulan
        ve herbir sonucu yeni bir array’in elemani yapan ve yeni array’i  ekrana  yazdiran bir program yaziniz { {1,2,3}, {4,5}, {6,7} }
...
*/
   ...
   int toplam=0;
        ...
        for (int i = 0; i <input.length ; i++) { // dis loop ve outer arrayi kontrol ediyor
